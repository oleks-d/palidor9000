...
public enum AbilityID_Old {
    ...
    AbilityID_Old(String value, String description, String icon, State state, AbilityType type, float castTime, float cooldown){
        this.value = value;
    ...
    public static AbilityID_Old getIDByName(String name){
        for (AbilityID_Old current : values()){
