...
public class VictoryScreen implements Screen {
    ...
    public VictoryScreen(HuntersGame game) {
        this.game = game;
        viewport = new FitViewport(HuntersGame.WIDTH, HuntersGame.HIGHT, new OrthographicCamera());
        stage = new Stage(viewport, ((HuntersGame) game).getBatch());
        ...
        Label gameDetailsLabel = new Label("Your story is over: " + HuntersGame.gameDetails, font);
