...
public class MainPanel implements Disposable {
    ...
    void update() {
        ...
        background = new Image(new Texture(HuntersGame.SPRITES_DIR + File.separator + "background_mainmenu.png"));

        //start = new Image(new Texture(HuntersGame.SPRITES_DIR + File.separator +"key.png"));
